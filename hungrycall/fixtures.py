...
SCENARIO_FIXTURES: Dict[str, Dict[str, Any]] = {
    ...
    "success_direct": {
        "rest_burger_house": {
            ...
            "transcript": [
                {"ts": "00:00:05", "speaker": "Agent", "text": "Hello, I am an automated assistant calling on behalf of Alex. Do you deliver to Hauptstraße 12?"},
    ...
    "vague_price_cascade": {
        "rest_burger_house": {
            ...
            "transcript": [
                {"ts": "00:00:05", "speaker": "Agent", "text": "Hello, calling on behalf of Alex. What is the total price for the burger menu?"},
        ...
        "rest_trattoria_luigi": {
            ...
            "transcript": [
                {"ts": "00:00:05", "speaker": "Agent", "text": "Hello, calling on behalf of Alex. Can you deliver to Hauptstraße 12?"},
    ...
    "budget_exceeded_cascade": {
        "rest_burger_house": {
            ...
            "transcript": [
                {"ts": "00:00:05", "speaker": "Agent", "text": "Hello, calling on behalf of Alex. What is the total price for delivery?"},
        ...
        "rest_trattoria_luigi": {
            ...
            "transcript": [
                {"ts": "00:00:05", "speaker": "Agent", "text": "Hello, calling on behalf of Alex. Can you deliver for 31.50 EUR total?"},
    ...
    "reservation_cascade": {
        "rest_trattoria_luigi": {
            ...
            "transcript": [
                {"ts": "00:00:05", "speaker": "Agent", "text": "Hello, calling on behalf of Alex. Do you have a table for 4 people on 2026-08-05 at 19:00?"},
                {"ts": "00:00:12", "speaker": "Restaurant", "text": "Yes, we have a table available at 19:00."},
                {"ts": "00:00:18", "speaker": "Agent", "text": "Please reserve it under the name Alex. What is your callback number in case we need to cancel?"},
                {"ts": "00:00:25", "speaker": "Restaurant", "text": "Reserved! Our callback number is +44 7700 900001. See you then!"}
            ]
        }
    },
    ...
    "pickup_cascade": {
        "rest_burger_house": {
            ...
            "transcript": [
                {"ts": "00:00:05", "speaker": "Agent", "text": "Hello, calling on behalf of Alex. Can we place a pickup order for 2 Burgers?"},
