...
def build_parser() -> argparse.ArgumentParser:
    ...
    deliv_parser.add_argument("--customer-name", default="Lukas", help="Name of person placing order")
    ...
    res_parser.add_argument("--customer-name", default="Lukas", help="Name under which to reserve")
    ...
    pickup_parser.add_argument("--customer-name", default="Lukas", help="Name of person picking up")
    ...
    demo_parser.add_argument("--customer-name", default="Lukas", help="Name of person placing demo order")
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if args.subcommand == "demo":
        req = UserRequest(
            mode=Mode.DELIVERY,
            customer_name=getattr(args, "customer_name", "Lukas"),
