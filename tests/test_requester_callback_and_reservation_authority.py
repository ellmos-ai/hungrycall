...
def test_web_request_requires_and_normalizes_the_human_callback():
    base = {
        ...
        "first_name": "Ada",
        "last_name": "Lovelace",
        "requester_callback_number": "+49 176 12345678",
...
def test_requester_callback_is_transient_and_never_persisted(tmp_path, monkeypatch):
    ...
    leaky_result = CallResult(
        ...
        structured_result={
            ...
            "debug": {
                ...
                "local_echo": "Call 0176 12345678 for confirmation",
            },
    ...
    assert "0176 12345678" not in json.dumps(leaky_result.structured_result)
