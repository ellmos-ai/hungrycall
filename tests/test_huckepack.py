...
def test_the_receipt_payload_carries_no_dialable_number():
    ...
    class Result:
        post_summary = "Bestellt bei 030 1234567."
        raw_transcript_text = "Kunde: Meine Nummer ist +49 170 1234567."
    ...
    payload = web.build_receipt_payload(
        ...
        structured={"callback_number": "+49 170 1234567", "total_price_eur": 18.5},
        call_result=Result(),
        customer_name="Ada",
    )
